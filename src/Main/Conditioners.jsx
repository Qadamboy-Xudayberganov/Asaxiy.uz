...
export default function Conditioners() {
  ...
  return (
    <>
      <Swiper
        ...
        loop={true}
        slidesPerView={5.3}
        className="h-[450px] max-w-[1392px]"
      >
        {source.map((item) =>
          item.category === "Conditioners" ? (
            <SwiperSlide
              key={item.id}
              className="h-[400px] mr-[20px] my-auto rounded-[20px] bg-white hover:scale-[1.04] transition-transform duration-300 hover:cursor-pointer"
            >
