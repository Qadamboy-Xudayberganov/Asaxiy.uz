        ...
        <div className="flex">
          ...
          <div className="w-[1044px] h-[100px]  px-[15px] r1200:w-full">
            <div className="h-10">
              ...
              <div className="max-w-full grid grid-cols-4 gap-4 r1100:grid-cols-3 r800:grid-cols-2 r600:grid-cols-1 r1200:hidden">
                {source.map((item) =>
                  item.category === "Noutbuklar" ? (
                    <div
                      key={item.id}
                      className="h-[400px] rounded-[20px] bg-white hover:scale-[1.04] transition-transform duration-300 hover:cursor-pointer shadow-lg"
                    >
                      <div className="w-full h-[150px] relative mb-4 flex justify-center items-center rounded-[20px]">
                        ...
                        <div>
                          <a href="" onClick={(e) => handleLikeClick(e, item)}>
                            <img
